...
/// One item inside a [`Tree`](super::Tree).
///
/// Can have zero or more `children`.
///
/// # Identifier
///
/// The generic argument `Identifier` is used to keep the state like the currently selected or opened [`TreeItem`]s in the [`TreeState`](super::TreeState).
///
...
///
/// Just like every file in a file system can be uniquely identified with its file and directory names each [`TreeItem`] in a [`Tree`](super::Tree) can be with these identifiers.
    ...
    Identifier: Clone + PartialEq + Eq + core::hash::Hash,
{
    ...
    ///
    /// When you choose to change the `identifier` the [`TreeState`](super::TreeState) might not work as expected afterwards.
    #[must_use]
